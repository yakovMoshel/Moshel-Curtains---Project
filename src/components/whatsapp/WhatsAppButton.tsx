...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed right-6 bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-stone-50 shadow-lg transition-transform hover:scale-105"
    >
